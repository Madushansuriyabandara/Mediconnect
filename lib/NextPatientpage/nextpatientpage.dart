import 'call.dart';
import 'package:mediconnect/NextPatientpage/procedtoprescription.dart';
import 'package:mediconnect/homepage/Widgets/line.dart';
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            //       SizedBox(height: 100),
            //       Center(
            //           child: Text("Page loading Error", style: TextStyle(fontSize: 16))),
            //     ],
            //   ),
            // );
            /////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // Uncomment this part for testing your own data
            const name = "Mr. Bandara";
            const age = '37';
            const disease = 'Fever with Vomiting';
            const condition = 'Gastric';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: line(Colors.grey, 200, 5),
                  ),
                  const SizedBox(height: 20),
                  Container(
                    padding: const EdgeInsets.only(left: 10),
                    child: procced(context),
                  ),
            ...
            // Fallback for any other scenario (should never reach here, but it's needed to avoid errors)
            return Container(
